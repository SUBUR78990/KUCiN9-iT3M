...
# Graphics #https://github.com/SUBUR78990/software/taag/#p=display&f=Graffiti&t=Type%20Something%20
...
{0}[{1}19{0}]{2} Extract apk from app           {0}[{1}24{0}]{2} Use Keycode            
 from app           {0}[{1}24{0}]{2} Use Keycode            
{0}[{1}20{0}]{2} Get Battery Status             {0}[{1}25{0}]{2}     
